...
SELECT CURRENT_DATE(), DATEDIFF('2021-12-31', '2000-12-15');
...
use market_db;
PREPARE myQuery FROM 'SELECT * FROM member WHERE mem_id = "BLK"'; # 마이쿼리에 넣기
EXECUTE myQuery; # 필요할떄 execute로 실행하기 ~ 동적 sql
